...
# SAVE_PATH="./models/Llama-3.2-1B-Instruct-Doc_mask-longt5_capt_70"
LLM_MODEL_PATH="./models/Meta-Llama-3-8B-Instruct-Doc_mask"
SAVE_PATH="./models/Meta-Llama-3-8B-Instruct-Doc_mask-longt5_capt_5"
# LLM_MODEL_PATH="./models/Mistral-7B-Instruct-v0.2-Doc_mask"
# SAVE_PATH="./models/Mistral-7B-Instruct-v0.2-Doc_mask-longt5_capt_1"
...
ALPHA=0 #隐藏层加权损失系数
BETA=0 #logits对齐损失系数
GAMA=1 #logits CE损失系数
KL_TEMPERATURE=2.0
BATCH_SIZE=4
EPOCHS=1
SCHEDULER_TYPE="linear"  # 可选值: "cosine", "linear", None
LOG_TOOL="wandb" # "tensorboard", "swanlab"， “wandb”
LOG_DESCRIPTION="小模型，去最后一个LN，双9W数据集，0-0-0-1损失,1epoch,，8B消融，104"
LOG_STEPS=80
SAVING_STEPS=8000
TRAIN_TOKEN=0
DEVICE_TRANSLATOR="cuda:0"
...
# ====================== 构建训练命令 ======================
CMD="python train_my_dyprag_104.py \
